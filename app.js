    ...
    */
    function renderizarProductos() {
        baseDeDatos.forEach((info) => {
         ...
         /*    miNodoImagen.addEventListener('mouseover', clicImgon); */
         ...
         function clicImgon() {
          ...
          if (  miNodoImagen.addEventListener('mouseover', clicImgoff)) {
           
  
          } else ( miNodoImagen.addEventListener('mouseout', clicImgon))
...
$(document).ready(function () {
    ...
    $('#btproducto').click(function (e) { 
        ...
        $('#productos').html('');
        $.getJSON('https://raw.githubusercontent.com/owakester/getajax/main/productos.json',function(data){
            //console.log(data);
...
$(document).ready(function() {
		...
		$("#colecciones").mouseleave(function(event) {
			$("#productos").fadeOut();
		});
